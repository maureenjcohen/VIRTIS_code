;+
; NAME:
;     Emission_Angle_Correction_1_31
;
; PURPOSE:
;     Correction of Emission Angle and Backscattering for VIRTIS calibrated data (either a single band or a full cube)
;
;     The correction implemented here comes from a scientific publication :
;        "Venus surface thermal emission at 1 mm in VIRTIS imaging observations: Evidence for variation of crust and mantle differentiation conditions"
;        N. Mueller, J. Helbert, G. L. Hashimoto, C. C. C. Tsang, S. Erard, G. Piccioni and P. Drossart
;        JOURNAL OF GEOPHYSICAL RESEARCH, VOL. 113, E00B17, doi:10.1029/2008JE003118, 2008
;
...
;
; CALLING SEQUENCE:
;     emission_angle_correction_1_31, QUBE=input_cube, EMband=input_EMband, CORRECTED_QUBE=cube, /NO_POPUPS
;
; INPUTS:
...
;         > emission_angle_correction_1_27, QUBE=band, EMband=EM, CORRECTED_QUBE=corrected_cube
;
; REQUIRED FILES:
...
;     Written by A.Cardesin, IASF-INAF, November 2015, Alejandro.Cardesin @ esa.int
;-

PRO emission_angle_correction_1_31, event, QUBE=input_cube, EMband=input_EMband, CORRECTED_QUBE=cube, NO_POPUPS=no_popups
...
for b=0,nb-1 do begin
	...
	cube[*,*,b] = cube[*,*,b] * cos(EMband) / (0.31 + 0.69*cos(EMband)) ; backscatter correction (see reference publication)
endfor
;---------------------------------------------------
