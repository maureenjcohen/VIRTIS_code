...
;
; PURPOSE:
;     Correction of Emission Angle for VIRTIS calibrated data at 5.0 microns
;
...
;
; CALLING SEQUENCE:
;     emission_angle_correction_5_0, QUBE=input_cube, EMband=input_EMband, CORRECTED_QUBE=cube, /NO_POPUPS
;
; INPUTS:
...
;         > emission_angle_correction_5_0, QUBE=band, EMband=EM, CORRECTED_QUBE=corrected_cube
;
; REQUIRED FILES:
...
PRO emission_angle_correction_5_0, event, QUBE=input_cube, EMband=input_EMband, CORRECTED_QUBE=cube, NO_POPUPS=no_popups
...
for b=0,nb-1 do begin
    ...
    cube[*,*,b] = cube[*,*,b] / (0.20  + 0.80 *cos(EMband)) ; (value for 4.0um Longobardo 2012 Table 7, first value latitudes 0-40)
;   cube[*,*,b] = cube[*,*,b] / (0.13  + 0.87 *cos(EMband)) ; (value for 4.0um Longobardo 2012 Table 7, also Grinspoon 1993)
endfor
;---------------------------------------------------
