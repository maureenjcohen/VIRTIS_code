;+
; NAME:
;     Emission_Angle_Correction_1_27
;
; PURPOSE:
...
;
; CALLING SEQUENCE:
;     emission_angle_correction_1_27, QUBE=input_cube, EMband=input_EMband, CORRECTED_QUBE=cube, /NO_POPUPS
;
; INPUTS:
...
PRO emission_angle_correction_1_27, event, QUBE=input_cube, EMband=input_EMband, CORRECTED_QUBE=cube, NO_POPUPS=no_popups
...
for b=0,nb-1 do begin
	...
	cube[*,*,b] = cube[*,*,b] * cos(EMband) / (1. + 2.*0.875*cos(EMband)) ; backscatter correction (see reference publication)
endfor
;---------------------------------------------------
