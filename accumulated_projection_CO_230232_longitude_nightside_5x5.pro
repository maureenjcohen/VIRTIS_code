...
PRO ACCUMULATED_PROJECTION_CO_230232_LONGITUDE_NIGHTSIDE_5X5, DEBUG=debug, NO_DISPLAY=no_display
...
; path_in    = "C:\VIRTIS\PDS_Test\"
  search_key = "VI"    ; filter key (e.g. "VI" for all infrared, "VI0345" full orbit 345, "VI034[4-7]" orbits 344-347 , "VI0345_00" one single cube, "VI0345_0[0-7]" cubes 00 to 07 from this orbit)
...
suffix              = 'CO_bandratio_2.30_2.32_MTP025' ;suffix for the PNG files, IDL save files and ENVI image files
...
;;==================================================================
 ...
 min_value           = -999 ; set minimum radiance value to be considered (to ignore bad pixels)
 max_value           = 999  ; (3~5 nightside, 150~200 dayside) set maximum radiance value to be considered (to ignore bad/saturated pixels)

 min_input           = 0.01 ; min input Radiance for CO (based on Tsang 2009)
 max_input           = 999 ;
 ...
 min_science_case_id = 1  ; set to use only nadirs (cases 1,2,3) or limbs (5/7)
 ...
 max_emergence_angle = 75.; max emergence angle to be considered, 90 for all, ~80 to avoid limbs, 40~60 to avoid emergence angle variations
...
;;==================================================================
 ...
 ;range=[0.01,0.06] ;typical for airglow
  range=[1   ,4   ] ;typical for CO band ratio
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
 IF disp_MAP || disp_iMAP then begin
	...
	v_map_projection, Z=Z, RANGE=range,$
	                  ...
	                  TITLE=suffix,center_latitude=0,$
