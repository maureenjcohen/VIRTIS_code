...
PRO ACCUMULATED_PROJECTION_CO_RATIO229_interp, DEBUG=debug, NO_DISPLAY=no_display,PATH_IN=path_in,SEARCH_KEY = search_key
  ...
  IF N_ELEMENTS(path_in   ) EQ 0 THEN path_in    = "D:\ARCHIVE\DATA\" ;"Z:\My Book\ARCHIVE\DATA\"   ;path_in    = "Z:\Desktop\VIRTIS data\"
  ...
  ;path_save  = "Z:\Desktop\VIRTIS CO band ratio results\100orbits\"
  path_save  = "C:\Users\alejandro cardesin\OneDrive - ESA\Desktop\VIRTIS CO band ratio results\ALL orbits\"
  ...
  suffix               = 'CO_bandratio_2.29_2.32_interpol1_150-165K_ALLexp' ;suffix for the PNG files, IDL save files and ENVI image files
  ...
  index_band       = 133  ; 2.29 at Tspect 155~156K
  ;index_band       = 134  ; 2.30 at Tspect 155~156K
  index_ratio      = 136  ; 2.32 at Tspect 155~156K

  ;index_band       = 135  ; 2.29 at Tspect 175
  ;index_band       = 136  ; 2.30 at Tspect 175
  ;index_ratio      = 138  ; 2.32 at Tspect 175
