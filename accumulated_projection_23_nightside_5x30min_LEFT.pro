...
PRO accumulated_projection_23_nightside_5x30min_LEFT, DEBUG=debug, NO_DISPLAY=no_display
...
; path_in    = "C:\VIRTIS\PDS_Test\"
 ...
 ; Path to save the IDL variables and ENVI images (if needed)
  path_save  = "C:\Users\alejandro cardesin\Dropbox\ESA\VIRTIS\Accumulated_projection_analysis\CO2_WINDOW\"
...
;;==================================================================
 ...
 suffix              = 'CO2_Window_2.3um_LEFT_920Orbits_NIGHTSIDE_LOCALTIME_ExpsGT0.1_maxEM80_minINC90_5x30min_values0-3' ;suffix for the PNG files, IDL save files and ENVI image files
...
;;==================================================================
 ...
 min_value           =  0 ; set minimum radiance value to be considered (to ignore bad pixels)
