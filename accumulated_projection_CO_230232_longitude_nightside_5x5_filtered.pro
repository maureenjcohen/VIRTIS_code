...
PRO ACCUMULATED_PROJECTION_CO_230232_LONGITUDE_NIGHTSIDE_5X5_FILTERED, DEBUG=debug, NO_DISPLAY=no_display
  ...
  path_in    = "E:\venus\VEX-V-VIRTIS-2-3-EXT1-V2.0\MTP007\"
  ...
  suffix              = 'CO_band_2.56_interp' ;suffix for the PNG files, IDL save files and ENVI image files
  ...
  If longitude then begin
    ...
    Xsize   =  96      ; number of elements of the grid on the X dimension
    XRange  = [-12, 12]; start and stop of the Xaxis used for the grid
    Xdelta  = 0.25      ; grid spacing on the X dimension
  endelse
