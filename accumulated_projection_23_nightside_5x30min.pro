...
PRO accumulated_projection_23_nightside_5x30min, DEBUG=debug, NO_DISPLAY=no_display
...
;;==================================================================
  ...
  path_in    = "C:\Users\mc5526\Desktop\MTP025"
; path_in    = "C:\VIRTIS\PDS_Test\"
 ...
 ; Path to save the IDL variables and ENVI images (if needed)
  path_save  = "C:\Users\mc5526\Desktop\Tests"
; path_save  = "C:\Documents and Settings\acardesin\Desktop"
 ; Path to save the PNG image of each grid (if needed)
  path_png   = "C:\Users\mc5526\Desktop\Tests"

;;==================================================================
;; Define Suffix of output files
;;==================================================================

 suffix              = 'CO2_Window_2.3um_MTP025' ;suffix for the PNG files, IDL save files and ENVI image files
...
;;==================================================================
 ...
 index_band       = 135+indgen(1) ; WINDOW 2.3um
...
;;==================================================================
 ...
 EMA_Correction_2_3  =  1 ; set to correct for Emission angle (for 2.3  um)
 ...
 min_value           =  0.02 ; set minimum radiance value to be considered (to ignore bad pixels)
 max_value           =  3 ; (3~5 nightside, 150~200 dayside) set maximum radiance value to be considered (to ignore bad/saturated pixels)

 min_expTime         = 0.1; set to consider only qubes that have a exposure time longer  than this value (in seconds)
 ...
 min_incidence_angle = 90.; min incidence angle to be considered,  0 for all, ~95 for only nightside
 ...
 longitude           =  1 ; set to 0 to plot with respect to Local Time, set to 1 to use Longitude instead

 only_coverage       =  0 ; 1 to get only the coverage from the geometry without looking at the data

 debug               =  1 ; 1 for debug mode, stop for errors

;;==================================================================
;; SELECT THE DISPLAY PARAMETERS (ignored if NO_DISPLAY is used)
;;==================================================================
 Color_Table     = 4 ; color table for the plot/contour/map
...
;;==================================================================
 ...
 Ysize    =   36     ; number of elements of the grid on the Y dimension
 Ydelta   =    5     ; grid spacing on the Y dimension
 YRange   = [-90, 90]; start and stop of the Yaxis used for the grid

 If longitude then begin
 ; X dimension LONGITUDE
 Xsize   =  72     ; number of elements of the grid on the X dimension
 XRange  = [0,360] ; start and stop of the Xaxis used for the grid
 Xdelta  =   5     ; grid spacing on the X dimension
 endif else begin
 ; X dimension LOCAL_TIME
 Xsize   =  48      ; number of elements of the grid on the X dimension
 XRange  = [-12, 12]; start and stop of the Xaxis used for the grid
 Xdelta  = 0.5      ; grid spacing on the X dimension
 endelse
